...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/Günlük_Seri-21%20g%C3%BCn-orange?style=flat-square" alt="Günlük Seri">
...
> Tüm yazılara şuradan göz atabilirsiniz: **[`TÜM YAZILAR`](yazilar/)**
...
> Üstteki yazı ise şurada: **[`ÖRNEK YAZI`](yazilar/2026-07-07.md)**
...
Tüm yazılar, düzenli bir akış sağlaması adına `yazilar/` klasörü içerisinde tutulur. Her günün yazısı, bu dizin altında o günün tarihiyle açılan bir Markdown (`.md`) dosyasıdır:

```
yazilar/YYYY-MM-DD.md
```
